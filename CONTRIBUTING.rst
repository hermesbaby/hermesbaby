...
``HermesBaby`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``HermesBaby``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/HermesBaby.git
    cd HermesBaby
...
.. _repository: https://github.com/<USERNAME>/HermesBaby
.. _issue tracker: https://github.com/<USERNAME>/HermesBaby/issues
.. <-- end -->
